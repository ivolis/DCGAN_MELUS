...
generator = keras.models.load_model(str(sys.argv[0]))
amount_images = int(sys.argv[1])
# generator.summary()
...
for k, image in enumerate():
    plt.imsave('image_{:04d}'.format(k), image.reshape(128,128)*127.5 + 127.5, cmap = 'gray')